...
export default function AboutPage(): JSX.Element {
  return (
    <main className="mx-auto w-full max-w-7xl px-2 py-16 sm:px-6 lg:px-8">
      <section className="rounded-[2rem] border border-[var(--color-light)] bg-white p-5 shadow-soft sm:p-8 lg:p-12">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {[
            ...
            <article key={point} className="rounded-3xl bg-[var(--color-light)] p-4 text-sm leading-6 text-slate-700 sm:p-6">
              {point}
            </article>
          ))}
        </div>
