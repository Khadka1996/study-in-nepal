        ...
        <div className="px-4 py-8 sm:px-10 lg:px-12 lg:py-12">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {universitiesMenuData.map((university) => {
              ...
              return (
                <article key={university.id} className="flex h-full min-h-[380px] flex-col overflow-hidden rounded-[1.9rem] border border-[rgba(15,42,95,0.12)] bg-white shadow-[0_18px_45px_rgba(8,26,58,0.08)]">
